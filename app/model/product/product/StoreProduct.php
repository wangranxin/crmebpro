        ...
        if ($value !== '') {
            switch ((int)$value) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    $query->where(['is_del' => 0, 'is_verify' => 1])->where(function ($query) {
...
//                    }
    ...
    public function searchLevelTypeAttr($query, $value)
    {
        if ('' !== $value) $query->where('level_type', $value);
    }
    public function searchIsBrokerageAttr($query, $value)
    {

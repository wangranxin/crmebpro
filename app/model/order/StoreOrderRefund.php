...
class StoreOrderRefund extends BaseModel
{
    ...
    {
        return $this->hasOne(StoreOrder::class, 'id', 'store_order_id')->field('id,shipping_type')->bind(['shipping_type']);
    }
    ...
    {
        return $this->hasOne(StoreOrder::class, 'id', 'store_order_id')->field('id, order_id, pay_type, paid, real_name,user_phone, user_address, pay_time')
            ->bind([

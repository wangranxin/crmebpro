...
class UserSearchServices extends BaseServices
{
	...
	*/
    public function vicSearch(int $uid, string $keyword, array $where, bool $isSearch = true)
    {
        //分词
        try {
    ...
    public function getUserList(int $uid)
    {
        ...
        return $this->dao->getList(['uid' => $uid, 'is_del' => 0], 'id,keyword,num', $page, $limit,'add_time desc,num desc');
    }

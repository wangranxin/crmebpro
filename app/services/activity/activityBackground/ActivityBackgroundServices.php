...
namespace app\services\activity\activityBackground;
...
/**
 * 活动背景图
 * Class ActivityBackgroundServices
 * @package app\services\activity\activityBackground
 * @mixin StorePromotionsDao
 */
class ActivityBackgroundServices extends BaseServices
{
    use OptionTrait;
    ...
    public function saveData(int $id, array $data)
    {
        ...
        switch ($data['product_partake_type']) {
            ...
            case 4://指定品牌
                ...
                if (count($data['brand_id']) != $brandCount) {
            ...
            case 5://指定商品标签
                ...
                if (count($data['store_label_id']) != $labelCount) {

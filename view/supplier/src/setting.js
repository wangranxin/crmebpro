...
// +----------------------------------------------------------------------
/**
 * iView supplier Pro 业务配置
 * */
// 请求接口地址 如果没有配置自动获取当前网址路径
const VUE_APP_API_URL = process.env.VUE_APP_API_URL || `${location.origin}/supplierapi`;
// 管理端ws
const VUE_APP_WS_ADMIN_URL = process.env.VUE_APP_WS_ADMIN_URL || `wss:${location.hostname}/ws`
...
const Setting = {
     ...
     * */
    // 网页标题的后缀
    titleSuffix: util.cookies.get('pageTitle'),
		// 后台配置目录

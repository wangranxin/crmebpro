  ...
  <div>
        ...
        <div class="head">
          <div class="full">
            ...
            <div v-if="rowActive.delete_time == null">
              ...
              <!--</Button>-->
              <Button v-if="orderData._status_new == 1" @click="edit"
                >编辑</Button
              >
              <Button
                v-if="
              ...
              <Button v-if="!formType" @click="changeMenu('4')"
                >售后备注</Button
              >
              <Button v-if="orderData.is_del == 1" @click="changeMenu('9')"
                >删除订单
              </Button>
              <Dropdown
                @on-click="changeMenu"
              ...
              >
                ...
                <DropdownMenu slot="list">
                  ...
                  <DropdownItem v-if="orderData._status_new === 4" name="8"
                    >已收货</DropdownItem
                  >
          ...
          <ul class="list">
            ...
            <li class="item">
              <div class="title">实际收入</div>
              <div>
                ¥{{
                  Number(orderDatalist.orderInfo.cost) +
                    Number(orderDatalist.orderInfo.pay_postage)
                }}
              </div>
            </li>
        ...
        <Tabs v-model="activeName">
          ...
          <TabPane label="商品信息" name="product">
            ...
            >
              ...
              <template slot-scope="{ row }" slot="settle_price">
                <div>{{ row.productInfo.attrInfo.settle_price }}</div>
              </template>
              <template slot-scope="{ row }" slot="total_price">
                <div>
                  {{
                    Number(row.productInfo.attrInfo.settle_price) * row.cart_num
                  }}
                </div>
              </template>
            </Table>
            ...
            >
              ...
              <template slot-scope="{ row }" slot="deliveryInfo">
                <div v-if="row.add_time">
                  <span>{{ row.status == 0 ? "创建时间" : "发货时间" }}</span
                  >：{{ row.add_time }}
                </div>
                <div
                  v-if="
    ...
    >
      <div
        ...
        v-if="orderDatalist || Object.keys(logisticsCon).length"
      >
        ...
        <div class="logistics_cent">
          <span
            >物流公司：{{
              Object.keys(logisticsCon).length
    ...
    getOrderData(data) {
      getExpress(data)
        .then(async (res) => {
          ...
          this.logisticsCon.delivery_name = res.data.delivery_name;
        })
        .catch((res) => {

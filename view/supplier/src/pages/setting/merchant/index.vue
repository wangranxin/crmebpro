            ...
            <template>
                <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="150">
                    ...
                    <FormItem label="供应商登录用户名:" prop="account">
                        <Input v-model="formValidate.account" placeholder="请输入登录名称" class="input"></Input>
                    </FormItem>
                    <FormItem label="供应商登录密码:" prop="pwd">
                        <Input v-model="formValidate.pwd" placeholder="请输入登录密码" class="input"></Input>
                    </FormItem>
                    <FormItem label="确认登录密码:" prop="conf_pwd">
                        <Input v-model="formValidate.conf_pwd" placeholder="请确认登录密码" class="input"></Input>
                    </FormItem>
                </Form>
            </template>
        </Card>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleSubmit (name) {
              // 如果邮箱不为空，则验证邮箱
                if(this.formValidate.email !== '' && !this.validateEmail(this.formValidate.email)){
            ...
            // 验证邮箱
            validateEmail(email) {
              const emailPattern = /^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$/i;

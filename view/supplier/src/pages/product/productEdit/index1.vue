    ...
    <div class="i-layout-page-header">
      <PageHeader class="product_tabs">
        <div slot="title" class="acea-row row-middle">
          <router-link :to="{ path: `/supplier/product/index` }">
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="rulesBox acea-row row-middle">
                        <draggable :list="item.detail" handle=".drag">
                          <Tag
                            ...
                            @dblclick.native="handleDblclick(index, indexn)"
                          >
                            <Input
                              ref="tagInput"
                              v-if="
                                editTagIndex ==
                                  index.toString() + indexn.toString()
                              "
...
export default {
  ...
  methods: {
    ...
    productTypeTap(num, item) {
      if (num == 1) {
        if (this.$route.params.id)
          return this.$Message.error("商品类型不能切换！");
    ...
    handleSubmit(name) {
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          this.formValidate.label_id = storeActiveIds;
          // 商品参数
    ...
    // 双击规格属性进行编辑
    handleDblclick(index, indexn) {
      this.editTagIndex = index.toString() + indexn.toString();
      this.$nextTick(() => {

 ...
 * @description 商品管理-- 审核
 */
export function productReviewApi(id, data) {
  return request({
    url: `/product/product/set_verify/${id}`,
    method: 'post',
    data
  });
}
 ...
 */
export function productGetTemplateApi(data) {
  return request({
 ...
 * @description 商品标签分组
 */
export function productLabelCate() {
  return request({
 ...
 * @description 商品标签列表
 */
export function productLabelListApi(params) {
  return request({
    url: 'product/label',
    method: 'get',
    params
...
/**
 * @description 商品标签--是否显示
 */
export function productLabelShowApi(data) {
  return request({
    url: `product/label/set_show/${data.id}/${data.is_show}`,
    method: 'put'
  });
}
/**
 * @description 商品标签--是否开启
 */
export function productLabelStatusApi(data) {
  return request({
    url: `product/label/set_status/${data.id}/${data.status}`,
    method: 'put'
  });
}
 ...
 * @description 商品标签--删除
 */
export function productLabelDeleteApi(data) {
  return request({
    url: `product/label/dels`,
    method: 'put',
    data
  });
}
 ...
 * @returns
 */
export function hotWordsAddApi(id, data) {
  return request({
    url: `product/words/${id}`,
    method: 'post',
    data
  });
}
 ...
 * @description 搜索热词列表
 */
export function hotWordsListApi(data) {
  return request({
    url: `product/words`,
    method: 'get',
    params: data
...
/**
 * @description 搜索热词--是否显示
 */
export function wordsSetShow(data) {
  return request({
    url: `product/words/set_show/${data.id}/${data.is_show}`,
    method: 'put'
  });
}
 ...
 * @description 搜索热词详情
 */
export function hotWordsInfoApi(id) {
  return request({
    url: `product/words/${id}`,
    method: 'get',
  });
 ...
 * @description 审核详情
 */
export function productGetVerifyApi(id) {
  return request({
    url: `product/product/get_verify/${id}`,
    method: 'get',
  });
}
...
export function productBrokerageUpdate(id, type, data) {
  return request({
    url: `product/other_update/${id}/${type}`,
    method: 'post',
    data
  });
}

 ...
 * @returns
 */
export function saveMemberContent(id, data) {
  return request({
    url: `/user/member/save/content/${id}`,
    method: "post",
    data,
  });
}
...
export function userImportApi(data) {
  return request({
    url: `/user/import_user`,
    method: "post",
    data,
  });
}

export function userImportRecordApi(params) {
  return request({
    url: `user/import_user/list`,
    method: "get",
    params,
  });
}

export function userDownRecordApi(params) {
    return request({
      url: `export/importUserExport`,
      method: "get",
      params,
    });
  }

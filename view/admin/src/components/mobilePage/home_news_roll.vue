<template>
  ...
  >
    <div
      ...
      v-if="styleConfig == 0"
    >
      <div class="img-box" v-if="titleConfig == 0">
        <img :src="imgUrl" alt="" />
      </div>
      <div
        class="top"
    ...
    >
      <div class="title acea-row row-between-wrapper">
        ...
        <div
          v-if="!buttonConfig"
          :style="{
            color: toneConfig ? bntColor : colorStyle.theme,
          }"
        >
      ...
      <div
        ...
        :key="index"
        :style="{
          color: toneConfig ? newsColor : colorStyle.theme,
        }"
      >
        <span
          class="num"
          :class="
            index == 0 ? 'on' : index == 1 ? 'on2' : index == 2 ? 'on3' : ''
          "
          >{{ index + 1 }}</span
        >{{ item.chiild[0].val }}
      </div>

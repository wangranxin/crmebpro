                    ...
                    <div class="wrapper" :style="'height:'+ clientHeight + 'px;'" v-if="tabCur == 0">
                        <div class="list" v-for="(item, index) in leftMenu" :key="index">
                            ...
                            >
                                ...
                                <!--:class="{ search: element.cname == '搜索框' , navbar: element.cname == '选项卡' }"-->
                                <div
...
<script crossorigin='anonymous'>
    import {categoryList, diyGetInfo, diySave, getUrl, setDefault, recovery,diyUpdateName,getRoutineCode} from "@/api/diy";
    ...
    export default {
        ...
        methods: {
			...
			bindHide(item){
				...
				console.log(obj[num].isHide)
				console.log('sd', this.$store.state.admin.mobildConfig.defaultArray);
				console.log('mConfig',this.mConfig);
				console.log('rConfig',this.rConfig);

...
<template>
  <div class="goods-import">
    ...
    <div class="download acea-row row-middle"  v-if="!importStatus">
      ...
      <a href="/statics/product_migration.xlsx" download class="download-text cup">下载Excel模板</a>
    </div>
    ...
    <div class="goods-upload mt20">
      ...
      <div v-show="fileUrl && importStatus" class="file-info">
        ...
        <div class="el-upload__text">
          共导入 {{ resultData.all }} 个，成功 {{ resultData.success }} 个，失败 {{ resultData.fail }} 跳过 {{ resultData.jump }} 个
        </div>
...
<script>
import { importProductImport } from '@/api/product';

  ...
  <div>
    <div class="i-layout-page-header">
      <PageHeader class="product_tabs" hidden-breadcrumb>
        <div slot="title">
          <router-link :to="{ path: '/admin/marketing/activity_background' }">
          ...
          <span
            v-text="$route.params.id ? '编辑活动背景' : '添加活动背景'"
            class="mr20 ml16"
          ></span>
        </div>
      </PageHeader>
                ...
                <Col class="tips">
                  ...
                  >
                    ...
                    <div class="exampleImg" slot="content">
                      <img
                        :src="
                          `${baseURL}/statics/system/activityBackground.png`
                        "
                        alt=""
                      />
                    </div>
...
import {
  activityBackgroundSave,
  activityBackgroundInfo,
} from "@/api/marketing";
...
export default {
  ...
  data() {
    return {
      ...
      ruleValidate: {
        ...
        image: [{ required: true, message: "请上传活动图", trigger: "change" }],
      },
      disabledDate(date) {
  ...
  methods: {
    ...
    //获取详情
    getInfo() {
      activityBackgroundInfo(this.$route.params.id)
        .then((res) => {
    ...
    handleSubmit: Debounce(function(name) {
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          activityBackgroundSave(this.$route.params.id, this.formValidate)
            .then((res) => {
              this.$router.push({

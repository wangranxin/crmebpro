	...
	<view :style="colorStyle">
		<view class="promoter-list">
			<view class="header">
				...
				<view class='nav acea-row row-around' v-if="brokerageLevel == 2 || type == 1">
					<view :class="grade == 0 ? 'item on' : 'item'" @click='setType(0)'>{{ type ? '代理商' : '一级' }}({{total}})</view>
					<view :class="grade == 1 ? 'item on' : 'item'" @click='setType(1)'>{{ type ? '员工' : '二级' }}({{totalLevel}})</view>
				</view>
